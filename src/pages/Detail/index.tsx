...
export const Detail: FC<IDetail> = () => {
  ...
  return (
    <div css={detailCss.detail} >
      {isLoading ? <Skeleton height={600} /> : <img css={detailCss.detailPoster} alt={movieContext?.movieDetail.Title} src={movieContext?.movieDetail.Poster && movieContext?.movieDetail.Poster.replace('300', '800').replace('jpg', 'webp')} />}
